      ...
      <div className="hidden lg:flex lg:w-3/4 bg-zinc-900 overflow-hidden relative flex-col justify-between p-16">
        ...
        <div className="relative z-10 space-y-8 max-w-lg">
          ...
          <h2 className="text-6xl font-semibold text-white leading-[0.9] special-font tracking-tight">
            Get started with <br /> <span className="text-zinc-500">Kiwiko.</span>
          </h2>
      ...
      <div className="w-full lg:w-1/2 flex flex-col items-center justify-center p-8 relative">
        ...
        {<div className="w-full max-w-md space-y-10">
          ...
          <div className="flex flex-col space-y-3">
            ...
            >
              <div className="relative flex items-center justify-center gap-3 py-3 border-2 border-zinc-200 rounded-lg hover:border-zinc-900 transition-all group-hover:bg-zinc-50">
