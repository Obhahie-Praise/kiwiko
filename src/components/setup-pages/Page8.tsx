      ...
      <div className="flex-1 flex flex-col items-center justify-center p-8 md:p-16 lg:p-24 relative">
        <div className="w-full max-w-xl space-y-12">
          ...
          <div className="space-y-2">
            <span className="text-xs font-medium text-emerald-600 uppercase tracking-wide">Step 08 / 08</span>
            <h1 className="text-4xl font-semibold text-zinc-900 special-font tracking-tight">Product fit.</h1>
          </div>
          ...
          <div className="space-y-10">
            ...
            <div className="space-y-2.5">
              ...
              <textarea
                ...
                className="w-full px-6 py-4 bg-zinc-50 border border-zinc-200 rounded-lg outline-none focus:ring-2 focus:ring-zinc-900/5 focus:border-zinc-900 transition-all font-medium text-zinc-900 min-h-[200px] resize-none"
              />
            </div>
          </div>
