  ...
  return (
    <div className="pt-24 pb-40 text-center relative overflow-hidden bg-white">
      ...
      <div className="max-w-4xl mx-auto px-6 relative z-10">
        {/* Headline */}
        <h1 className="hero-font text-5xl md:text-[5.5rem] leading-[1.1] tracking-[-0.03em] text-zinc-900 font-bold mb-8 animate-in fade-in slide-in-from-bottom-8 duration-1000">
        ...
        <p className="text-xl text-zinc-500 font-medium max-w-2xl mx-auto mb-10 leading-relaxed animate-in fade-in slide-in-from-bottom-12 duration-1000 delay-200">
          Manage projects effortlessly with smart tools, stay on track, 
          meet deadlines, and keep your team productive.
        </p>
        ...
        <div className="relative mt-8 animate-in fade-in slide-in-from-bottom-24 duration-1000 delay-500">
          <div className="rounded-[2.5rem] p-3 bg-zinc-100/50 backdrop-blur-sm border border-zinc-200 shadow-2xl overflow-hidden">
